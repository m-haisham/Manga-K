...
if __name__ == "__main__":
    if not os.path.exists(Const.StyleSaveFile):
        print('{0} does not exist, run while it exists'.format(Const.StyleSaveFile))
        print('Running main.py will regenerate {0} saved as style.py'.format(Const.StyleSaveFile))
